...
#ifndef GRAPHOS_ORIENTATION_FORMAT_BUNDLER_WIDGETS_H
#define GRAPHOS_ORIENTATION_FORMAT_BUNDLER_WIDGETS_H
...
class GRAPHOS_EXPORT BundlerFormatWidget
...
class GRAPHOS_EXPORT BundlerFormatWidgetImp
...
#endif // GRAPHOS_ORIENTATION_FORMAT_BUNDLER_WIDGETS_H
