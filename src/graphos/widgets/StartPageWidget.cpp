...
void StartPageWidget::initUI()
{
    ...
    verticalLayout->addItem(vertical_spacer);

    mSplitter->addWidget(layoutWidgetButtons);

    QWidget *layout_widget2 = new QWidget(mSplitter);
    QVBoxLayout *vertical_layout2 = new QVBoxLayout(layout_widget2);
    vertical_layout2->setSpacing(6);
    vertical_layout2->setContentsMargins(11, 11, 11, 11);
    vertical_layout2->setContentsMargins(9, 9, 9, 9);
    mLabelRecentProjects = new QLabel(layout_widget2);
    ...
    vertical_layout2->addWidget(mLabelRecentProjects);

    mListWidgetRecentProjects = new QListWidget(layout_widget2);
    QFont font2;
    ...
    vertical_layout2->addWidget(mListWidgetRecentProjects);

    mCommandLinkButtonClearHistory = new QCommandLinkButton(layout_widget2);
    ...
    vertical_layout2->addWidget(mCommandLinkButtonClearHistory);

    mSplitter->addWidget(layout_widget2);
