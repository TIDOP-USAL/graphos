...
public:
    ...
    MatchingProperties();
    MatchingProperties(const MatchingProperties &featureMatching) noexcept = default;
    MatchingProperties(MatchingProperties &&featureMatching) noexcept = default;
    virtual ~MatchingProperties() = default;

    auto operator=(const MatchingProperties &featureMatching) -> MatchingProperties & = default;
    auto operator=(MatchingProperties &&featureMatching) noexcept -> MatchingProperties & = default;
