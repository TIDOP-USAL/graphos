...
#ifndef GRAPHOS_CORE_CAMERA_ODM_CALIBRATION_READER_H
#define GRAPHOS_CORE_CAMERA_ODM_CALIBRATION_READER_H
...
class OpenDroneMapCalibrationReader 
...
#endif // GRAPHOS_CORE_CAMERA_ODM_CALIBRATION_READER_H
