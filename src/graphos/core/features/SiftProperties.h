...
class SiftProperties
  : public FeatureExtractorProperties
{
...
public:
     ...
     */
    SiftProperties(const SiftProperties &sift) = default;

    SiftProperties(SiftProperties &&sift) noexcept = default;
    ...
    auto operator=(const SiftProperties &sift) -> SiftProperties & = default;
     ...
     */
    auto operator=(SiftProperties &&sift) noexcept -> SiftProperties & = default;
