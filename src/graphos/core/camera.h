#ifndef GRAPHOS_CAMERA_H
#define GRAPHOS_CAMERA_H
...
class GRAPHOS_EXPORT Calibration
{
...
class GRAPHOS_EXPORT CalibrationFactory
{
...
//class GRAPHOS_EXPORT WriteCalibration
//{
//
//public:
//
