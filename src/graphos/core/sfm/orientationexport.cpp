...
//void OrientationExport::exportVRML(const tl::Path &path) const
//{
//    if (mReconstruction) {
...
//void OrientationExport::exportOrientation(const tl::Path &path, bool bQuaternion) const
//{
//    if (mReconstruction) {
...
//void OrientationExport::exportPix4DCalibration(const tl::Path &path, const tl::Path &imagePath) const
//{
...
//void OrientationExport::exportMVE(const tl::Path &path) const
//{
//
//    if (mReconstruction) {
//
...
//                tl::Message::error("The output directory cannot be created: {}", path.toString());
//                return;
//            }
//        }
//
//        std::ofstream stream(tl::Path(path).append("synth_0.out").toWString(), std::ios::trunc);
//
...
//                        //    }
//                        //}
//                        tl::Path ini_file(path);
//                        ini_file.append("views").append("view_000");
//                        ini_file.append(std::to_string(image.second.ImageId() - 1).append(".mve"));
//                        if (!ini_file.createDirectories()){
//                            tl::Message::error("The output directory cannot be created: %s", ini_file.toString());
//                        }
//
//                        std::ofstream stream_ini(tl::Path(ini_file).append("meta.ini").toWString(), std::ios::trunc);
//
...
//void OrientationExport::exportBundler(const tl::Path &oriFile) const
//{
//
//    if (mReconstruction) {
//
//        std::ofstream stream(oriFile.toWString(), std::ios::trunc);
//        if (stream.is_open()) {
//
