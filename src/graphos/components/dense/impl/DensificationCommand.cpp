    ...
    mDisableCuda(false)
{
    ...
    this->addArgument<int>("pmvs:cell_size", "Cell Size (default = 2)", 2);
    this->addArgument<double>("pmvs:threshold", "Threshold (default = 0.7)", 0.7);
    this->addArgument<int>("pmvs:window_size", "Window Size (default = 7)", 7);
    this->addArgument<int>("pmvs:minimun_images", "Minimun Image Number (default = 3)", 3);
    this->addArgument<bool>("pmvs:original_depth", "Image Original Depth (default = false)", false);
    this->addArgument<int>("smvs:input_image_scale", "Input Image Scale (default = 1)", 1);
    this->addArgument<int>("smvs:output_depth_scale", "Output Depth Scale (default = 2)", 2);
    this->addArgument<bool>("smvs:shading_optimization", "Shading Based Optimization (default = false)", false);
    this->addArgument<bool>("smvs:sgm", "Semi-global Matching (default = true)", true);
    this->addArgument<double>("smvs:smooth_factor", "Surface Smoothing Factor (default = 1.0)", 1.0);
    this->addArgument<bool>("segment", 's', "Auto-segmentation (default = false)", false);
