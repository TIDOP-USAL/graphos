...
public:
     ...
     * Constructs a CmvsPmvsTask object with provided parameters.
     ...
     */
    CmvsPmvsTask(const std::shared_ptr<CmvsPmvsProperties> &properties,
    ...
    ~CmvsPmvsTask() override;

    TL_DISABLE_COPY(CmvsPmvsTask)
    TL_DISABLE_MOVE(CmvsPmvsTask)
...
private:
    ...
    std::shared_ptr<CmvsPmvsProperties> mProperties;
