...
//#ifndef  READ_POINTS
            ...
            //    tl::Message::info("Poisson Reconstruction");
            //    /*CGAL::Surface_mesh<Point_3>*/SurfaceMesh output_mesh;
            //    CGAL::poisson_surface_reconstruction_delaunay(points.begin(), points.end(),
            //                                                  points.point_map(), points.normal_map(),
            //                                                  output_mesh, spacing);

            //    
            //    CGAL::Bbox_3 cgal_bbox = CGAL::bbox_3(output_mesh.points().begin(), output_mesh.points().end());
            ...
            //    tl::Message::info("Extract DTM from Mesh");

            //    cv::Mat dsm_raster = extractDTMfromMesh(output_mesh, bbox, progressBar, mGSD, mOffset.z);
