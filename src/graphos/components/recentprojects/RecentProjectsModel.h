...
#ifndef GRAPHOS_RECENT_PROJECTS_MODEL_INTERFACE_H
#define GRAPHOS_RECENT_PROJECTS_MODEL_INTERFACE_H
...
/*!
 * \brief RecentProjectsModel interface
 */
...
#endif // GRAPHOS_RECENT_PROJECTS_MODEL_INTERFACE_H
