...
void Orthoimage::run(const tl::Path &ortho, const cv::Mat &visibilityMap)
{
    ...
    try {
        ...
        tl::RasterWriter orthophoto_writer(ortho);
        ...
        tl::BoundingBox2d window_projected = tl::envelope(top_left_projected,
                                                          top_right_projected,
                                                          bottom_right_projected,
                                                          bottom_left_projected);
        ...
        //} else {
            ...
            for (int iy = 0; iy < ny; ++iy) {
                ...
                for (int ix = 0; ix < nx; ++ix) {
                    ...
                    auto proj = mGeoreference.transform(tl::Point2d{static_cast<double>(c),static_cast<double>(r)});
        ...
        //for(int r = 0; r < out_height; ++r){
            for (int c = 0; c < orto_size.width; c++) {
                ...
                //} else {
                    ...
                    enu_coordinates = tl::Point3d{ex, ey, 0.0};
                //}

                auto dtm_pixel_coordinates = mOrthorectification->terrainToDsmImageCoordinates(static_cast<tl::Point2d>(enu_coordinates));
                ...
                enu_coordinates.z() = mOrthorectification->z(static_cast<tl::Point2d>(enu_coordinates));
                ...
                if (rect_image.contains(static_cast<tl::Point2i>(photo_image_coord))) {
...
auto Orthoimage::readImage() -> cv::Mat
{
    ...
    try {
        ...
        tl::RasterReader image_reader(mImage);
