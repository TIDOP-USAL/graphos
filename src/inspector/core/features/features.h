#ifndef INSPECTOR_FEATURES_H
#define INSPECTOR_FEATURES_H
...
class INSPECTOR_EXPORT Feature
{
...
class INSPECTOR_EXPORT KeypointDetector
{
...
class INSPECTOR_EXPORT DescriptorExtractor
{
...
class INSPECTOR_EXPORT FeatureExtractor
{
