...
void CamerasImportViewImp::initSignalAndSlots()
{
  ...
  //connect(mComboBoxXColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::xColumnChange);
  connect(mComboBoxXColumn, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &CamerasImportView::xFieldIdChanged);
  //connect(mComboBoxYColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::yColumnChange);
  connect(mComboBoxYColumn, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &CamerasImportView::yFieldIdChanged);
  //connect(mComboBoxZColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::zColumnChange);
  ...
  //connect(mComboBoxQxColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::qxColumnChange);
  //connect(mComboBoxQyColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::qyColumnChange);
  //connect(mComboBoxQzColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::qzColumnChange);
  //connect(mComboBoxQwColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::qwColumnChange);
  //connect(mComboBoxYawColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::yawColumnChange);
  //connect(mComboBoxPitchColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::pitchColumnChange);
  //connect(mComboBoxRollColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::rollColumnChange);
  //connect(mComboBoxOmegaColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::omegaColumnChange);
  //connect(mComboBoxPhiColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::phiColumnChange);
  //connect(mComboBoxKappaColumn, &QComboBox::currentTextChanged, this, &CamerasImportView::kappaColumnChange);
