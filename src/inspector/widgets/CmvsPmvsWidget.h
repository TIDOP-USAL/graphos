#ifndef INSPECTOR_CMVS_PMVS_WIDGET_H
#define INSPECTOR_CMVS_PMVS_WIDGET_H
 ...
 */
class INSPECTOR_EXPORT CmvsPmvsWidget
  : public IWidgetView
{
  Q_OBJECT
...
class INSPECTOR_EXPORT CmvsPmvsWidgetImp
...
#endif // INSPECTOR_CMVS_PMVS_WIDGET_H
