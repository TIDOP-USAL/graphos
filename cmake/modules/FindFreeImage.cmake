...
SET(FREEIMAGE_DIR "" CACHE PATH "Root folder of FREEIMAGE")
...
if(CMAKE_CL_64)
    list(APPEND FREEIMAGE_LIBRARY_DIRS ${FREEIMAGE_DIR}/lib/x64)
else()
    list(APPEND FREEIMAGE_LIBRARY_DIRS ${FREEIMAGE_DIR}/lib/x32)
endif()
