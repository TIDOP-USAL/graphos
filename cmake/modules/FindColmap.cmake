...
if(COLMAP_FOUND)
  set(COLMAP_LIBRARIES 
      ...
      optimized 
	  	  ${COLMAP_FLANN_LIBRARY}
	    debug
	      $<$<BOOL:${FOUND_COLMAP_GRACLUS_LIBRARY_DEBUG}>:${COLMAP_GRACLUS_LIBRARY_DEBUG}>
      optimized 
        $<$<BOOL:${FOUND_COLMAP_GRACLUS_LIBRARY}>:${COLMAP_GRACLUS_LIBRARY}>
      debug
		    ${COLMAP_LSD_LIBRARY_DEBUG}
	    optimized
		    ${COLMAP_LSD_LIBRARY}
